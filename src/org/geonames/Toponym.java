...
public class Toponym {
	...
	public String getAdminCode1ISO() throws InsufficientStyleException {
		if (adminCode1ISO == null && style != null
				&& Style.LONG.compareTo(style) > 0) {
			throw new InsufficientStyleException(
					"adminCode1ISO not supported by style " + style.name());
		}
		return adminCode1ISO;
	}
	
	public void setAdminCode1ISO(String adminCode1ISO) {
		this.adminCode1ISO = adminCode1ISO;
	}
	/**
	 * @param adminCode1
