...
public class WebService {
	...
	private static Toponym getToponymFromElement(Element toponymElement) {
		...
		List<Element> children = toponymElement.getChildren("adminCode1");
		if (children.size() > 0) {
			Element adminCode1Element = children.get(0);
			toponym.setAdminCode1ISO(adminCode1Element.getAttributeValue("ISO3166-2"));			
		}
